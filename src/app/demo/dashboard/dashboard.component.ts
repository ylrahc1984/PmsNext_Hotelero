...
export class DashboardComponent implements OnInit {
  ...
  private buildGeneralMetrics(): DashboardMetricView[] {
    ...
    return [
      ...
      this.createMetric({ label: 'PROYECCIÓN AL CIERRE', description: 'Ocupación proyectada al cierre', icon: 'bi-calendar2-week', tone: 'pink', sections: ['FORECAST'], indicators: ['HOY HABITACIONES PROYECTADAS'] }),
